...
public class HotelGuestDetailsFragment extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        String hotelGuestName = getArguments().getString("guest user name");

        hotelRecapTextView.setText("Dear "+hotelGuestName+" You have Selected " +hotelName+ ". The Cost Will be  "+hotelPrice+ " and Availability is " +hotelAvailability);
